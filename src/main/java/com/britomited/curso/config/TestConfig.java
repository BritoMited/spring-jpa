package com.britomited.curso.config;
...
import com.britomited.curso.entities.Payment;
import com.britomited.curso.entities.Product;
import com.britomited.curso.entities.User;
import com.britomited.curso.entities.enums.OrderStatus;
import com.britomited.curso.repositories.CategoryRepository;
import com.britomited.curso.repositories.OrderItemRepository;
import com.britomited.curso.repositories.OrderRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		User u3 = new User(null, "Barb", "Barb@gmail.com", "33333333", "123456");
		
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"),OrderStatus.DELIVERED, u1);
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"),OrderStatus.PAID, u3);
